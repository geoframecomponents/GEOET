...
public class OutputWriterMain {
	...
	public void process() throws Exception {
		...
		if (doPrintOutputPT == false && doPrintOutputPM == false && doPrintLess == false) {
			...
			if (doFullPrint == true) {
				storeResultFull(input.ID, variables.latentHeatFluxSun, variables.latentHeatFluxShade,
						variables.evaporation, variables.transpiration, variables.evapoTranspiration,
						variables.fluxEvaporation, variables.fluxTranspiration, variables.fluxEvapoTranspiration,
						variables.sensibleHeatFluxSun, variables.sensibleHeatFluxShade, variables.leafTemperatureSun,
						variables.leafTemperatureShade, variables.shortwaveCanopySun, variables.shortwaveCanopyShade,
						variables.incidentSolarRadiationSoil, variables.areaCanopySun, variables.vapourPressureDeficit);
			} else {
				storeResult(input.ID, variables.latentHeatFluxSun, variables.latentHeatFluxShade, variables.evaporation,
						variables.transpiration, variables.evapoTranspiration, variables.fluxEvaporation,
						variables.fluxTranspiration, variables.fluxEvapoTranspiration, variables.leafTemperatureSun,
						variables.leafTemperatureShade);
			}
		}
	...
	private void storeResultFull(int ID, double latentHeatSun, double latentHeatShadow, double evaporation,
			double transpiration, double evapoTranspiration, double fluxEvaporation, double fluxTranspiration,
			double fluxEvapoTranspiration, double sensibleHeatFluxLight, double sensibleHeatFluxShadow,
			double leafTemperatureSun, double leafTemperatureShadow, double radiationCanopyInLight,
			double radiationCanopyInShadow, double incidentSolarRadiationSoil, double leafInSunlight,
			double vapourPressureDeficit) throws SchemaException {
	...
	private void storeResult(int ID, double latentHeatSun, double latentHeatShadow, double evaporation,
			double transpiration, double evapoTranspiration, double fluxEvaporation, double fluxTranspiration,
			double fluxEvapoTranspiration, double leafTemperatureSun, double leafTemperatureShadow)
