...
//	private Double _windSpeedH;

	// TODO check how this was used in the original code. 
	// it seems the method was called several times and value assigned to variables beofore even if variables
	// was a singleton. So I will just compute the value and return it, without caching it in a private variable.
