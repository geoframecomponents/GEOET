...
public class ComputeQuantitiesProspero {
	...
	public ComputeQuantitiesProspero(Leaf leafparameters, Parameters parameters, ETProblemQuantities variables) {
		this.leafparameters = leafparameters;
		this.parameters = parameters;
		this.variables = variables;
	}

	public void computeQuantitiesProspero(double windVelocity, double canopyHeight, double airTemperature,
		...
		if (variables.shortwaveCanopySun == 0 && shortWaveRadiationDirect == 0 && shortWaveRadiationDiffuse == 0) {
			...
			variables.radFactorSun = (shortWaveRadiationDirect * 2.1 + shortWaveRadiationDiffuse * 2.1)
					/ variables.shortwaveCanopySun;
			variables.shortwaveCanopySun = (shortWaveRadiationDirect + shortWaveRadiationDiffuse)
		...
		if (variables.shortwaveCanopyShade == 0 && shortWaveRadiationDirect == 0 && shortWaveRadiationDiffuse == 0) {
			...
			variables.radFactorShade = (shortWaveRadiationDirect * 2.1 + shortWaveRadiationDiffuse * 2.1)
					/ variables.shortwaveCanopyShade;
			variables.shortwaveCanopyShade = (shortWaveRadiationDirect + shortWaveRadiationDiffuse)
					/ variables.radFactorShade;
		}
