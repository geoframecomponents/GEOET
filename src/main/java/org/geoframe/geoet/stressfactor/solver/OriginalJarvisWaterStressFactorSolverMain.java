...
import org.geoframe.geoet.stressfactor.methods.*;
...
public class OriginalJarvisWaterStressFactorSolverMain extends HMModel {
	...
	public void solve() {
		...
		if (step == 0) {
			...
			stressFactor = WaterStressFactorFactory.createStressFactor(stressFactorModel, thetaWp, thetaFc, ID, z, deltaZ,
					NUM_CONTROL_VOLUMES, totalDepth);

			representativeSF = RepresentativeStressFactorFactory.createRepresentativeStressFactor(representativeStressFactorModel,
					z, deltaZ, NUM_CONTROL_VOLUMES, totalDepth, null);
