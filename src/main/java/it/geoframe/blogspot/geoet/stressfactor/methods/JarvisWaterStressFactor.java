...
public class JarvisWaterStressFactor extends WaterStressFactor{

	/** General constructor used to pass the value of variables */
	public JarvisWaterStressFactor (double[] thetaWp, double[] thetaFc,int[] ID, double[] z, double[] deltaZ, int NUM_CONTROL_VOLUMES, double totalDepth) {
