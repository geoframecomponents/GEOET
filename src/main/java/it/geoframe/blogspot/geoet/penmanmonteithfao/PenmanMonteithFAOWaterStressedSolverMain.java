...
@Description("Calculates water stressed evapotranspiration at any timestep using FAO Penman-Monteith equation and water stress factor according FAO formulation")
...
public class PenmanMonteithFAOWaterStressedSolverMain {
...
*/
            ...
            //windSpeedWithZ.setParams(canopyHeight, windVelocity);
            
            //double windAtZ = windSpeedWithZ.windAtZ_AboveGroundSurface();
            ...
            //waterStress.setParams(depletionFraction, soilMosture, rootsDepth, waterFieldCapacity, waterWiltingPoint);
            //waterStress.totalAvailableWater();
            // waterStress.rootZoneDepletation();
            //waterStress.readilyAvailableWater();
            
            //double waterFAOStressFactor = waterStress.waterStressCoefficient();
	    	
	    	/*FAO.setNumber(airTemperature, atmosphericPressure, netRadiation, relativeHumidity, soilHeatFlux, windAtZ);
	    	
	    	double pmfaoetp = FAO.doET()*waterFAOStressFactor*cropCoefficient;
