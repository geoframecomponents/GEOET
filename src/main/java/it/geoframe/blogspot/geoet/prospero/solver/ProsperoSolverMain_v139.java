...
public class ProsperoSolverMain_v139 {
	...
	ComputeQuantities_v139 computeQuantities = new ComputeQuantities_v139();
	...
	public void process() throws Exception {
		...
		computeQuantities.computeQuantities(input.windVelocity, canopyHeight, input.airTemperature, input.relativeHumidity, input.atmosphericPressure, variables.date, input.latitude, input.longitude, input.time, input.leafAreaIndex, typeOfCanopy, input.shortWaveRadiationDirect, input.shortWaveRadiationDiffuse, input.netRadiation);
