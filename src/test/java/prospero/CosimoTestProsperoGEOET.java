 ...
 */
public class CosimoTestProsperoGEOET{
	@Test
    public void Test() throws Exception {
		String startDate= "2017-03-11 12:00";
        String endDate	= "2017-03-11 14:00";
        int timeStepMinutes = 60;
        String fId = "ID";
        String lab1 = "_totalstress_Cosimo2";
        ...
        String inPathToLai 						="resources/Input/dataET_point/1/Cosimo/LAI_1.csv";
