 ...
 */
public class TestProsperoGEOET_Cosimo_v139{
	@Test
    public void Test() throws Exception {
		String startDate= "2017-01-01 12:00";
        String endDate	= "2017-12-01 00:00"; 
        int timeStepMinutes = 60;
        String fId = "ID";
        String lab1 = "_actualnew_lai_all20_150223";
		...
		String inPathToTemperature 				="resources/Input/dataET_point/1/Cosimo/airT_1.csv";
        String inPathToWind 					="resources/Input/dataET_point/1/Cosimo/Wind_1.csv";
        String inPathToRelativeHumidity 		="resources/Input/dataET_point/1/Cosimo/RH_1.csv";
        String inPathToShortWaveRadiationDirect ="resources/Input/dataET_point/1/Cosimo/ShortwaveDirect_1.csv";
        String inPathToShortWaveRadiationDiffuse="resources/Input/dataET_point/1/Cosimo/ShortwaveDiffuse_1.csv";
        String inPathToLWRad 					="resources/Input/dataET_point/1/Cosimo/LongDownwelling_1.csv";
        String inPathToNetRad 					="resources/Input/dataET_point/1/Cosimo/Net_1.csv";
        String inPathToSoilHeatFlux 			="resources/Input/dataET_point/1/Cosimo/GHF_1.csv";
        String inPathToPressure 				="resources/Input/dataET_point/1/Cosimo/Pres_1.csv";
        String inPathToLai 						="resources/Input/dataET_point/1/Cosimo/LAIall20.csv";
        String inPathToCentroids 				="resources/Input/dataET_point/1/centroids_ID_1.shp";
        String inPathToSoilMoisture				="resources/Input/dataET_point/1/Cosimo/Moisture_1.csv";
		...
		ProsperoSolverMain_v139 Prospero 						= new ProsperoSolverMain_v139();
		...
		ProsperoStressFactor.waterWiltingPoint = 0.18;
		ProsperoStressFactor.waterFieldCapacity = 0.25; 
