...
/**
 * Test GEOET Prospero-transpiration and Penman Monteith-soil evaporation
 * version
 * 
 * @author D'Amato Concetta, Michele Bottazzi (concetta.damato@unitn.it)
 */
public class TestProspero_SoilEvaporationPM_GEOET extends GeoetTestCase {
	@Test
	public void Test() throws Exception {
		...
		inputPreprocessor.canopyHeight = 1.26;
		...
		prosperoStressFactor.evaporationDepth = 0.5;
